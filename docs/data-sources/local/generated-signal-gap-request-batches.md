...
- Counties: 連江縣, 金門縣, 臺東縣, 苗栗縣, 澎湖縣, 南投縣, 嘉義市, 基隆市, 新北市, 新竹縣, 臺中市
...
- Packet generator command: `PYTHONPATH=apps/api python scripts/local-source-request-packets.py --format markdown --signal-type pump_or_gate_status --county 連江縣 --county 金門縣 --county 臺東縣 --county 苗栗縣 --county 澎湖縣 --county 南投縣 --county 嘉義市 --county 基隆市 --county 新北市 --county 新竹縣 --county 臺中市`
