...
| `OFFICIAL_NATIONWIDE_HISTORY_CITATIONS_ENABLED` | `false` (default since 2026-09-04); request-time Google News/Bing citation lookup, disabled because it slowed every assessment and admitted non-incident pages; persisted rows are excluded while off |
