...
evidence smoke also requires checked, non-stalled worker source-health records
in `nearby_realtime_coverage`; fresh request-time diagnostic observations alone
can no longer satisfy the worker evidence gate.
