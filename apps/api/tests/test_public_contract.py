...
def test_required_schema_readiness_checks_latest_migration_and_relations() -> None:
    ...
    assert captured["params"] == (
        54,
        "0054_nationwide_recent_flood_history.sql",
        "337261b595c53e9c1293dcf20185807427eadd3408e084fec3ed1ff01c66c3f6",
        54,
...
def test_required_schema_readiness_rejects_partial_migration() -> None:
    ...
    with pytest.raises(RuntimeError, match="required database schema migration 0054 is incomplete"):
        health_routes._check_required_schema(FakeCursor())
