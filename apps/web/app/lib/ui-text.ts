...
export const text = {
  ...
  nearbySensingQuestion: "回答：附近感測器有沒有足夠覆蓋？距離是感測器到查詢點，不是量測值。",
  nearbySensingGaps: "缺口",
  evidenceKicker: "資料證據",
  evidenceTitle: "判讀依據",
  evidenceQuestion: "回答：哪些來源支撐這次判讀？",
  evidenceScopeNote:
    "優先列出官方、即時與可驗證資料；來源可信度由官方程度、資料新鮮度、與查詢點關聯估算，不是淹水機率或風險分數；歷史新聞暫停顯示。",
  ...
  diagnosticsCoverageFreshness: "fresh / stale / status-only",
