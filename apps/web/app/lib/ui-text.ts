...
export const text = {
  ...
  betaLimitTitle: "非即時災害通報",
  betaLimitAction: "使用限制",
  betaLimitMessage:
  ...
  evidenceTitle: "判讀依據",
  evidenceScopeNote:
    "優先顯示官方、即時且可驗證的來源；可信度不是淹水機率。",
  evidenceUsage: "這筆資料如何使用",
  hiddenNewsEvidence: "已隱藏歷史新聞來源",
  evidenceSource: "來源",
  evidenceConfidence: "來源可信度",
  evidenceHistoricalConfidence: "來源／位置可信度",
  evidenceDistance: "距查詢點",
  evidenceObservedAt: "觀測",
  evidenceCountSuffix: "筆來源",
  evidenceTime: "觀測 / 發布",
  evidenceHistoricalTime: "紀錄日期",
  evidenceHistoryTitle: "歷史淹水查核（近 15 年）",
  evidenceHistoryOrder: "依日期由新到舊；預設顯示最新一筆",
  evidenceHistoryExpand: "展開其餘歷史紀錄",
  evidenceHistoryOpen: "展開歷史紀錄",
  evidenceHistoryPreviewEmpty: "風險摘要沒有可顯示的歷史紀錄預覽；仍可展開查詢，查無紀錄不代表安全。",
  evidenceHistoryLoading: "正在載入歷史紀錄…",
  evidenceHistoryError: "歷史紀錄載入失敗，已保留最新預覽資料。",
  evidenceHistoryExpired: "此查詢已過期，請重新查詢地點以載入歷史紀錄。",
  evidenceHistoryRetry: "重試",
  evidenceHistoryNoMore: "目前沒有更多可列出的歷史紀錄；這不代表此地點未曾淹水。",
  evidenceHistoryLoadMore: "載入更多",
  evidenceHistoryCoverageLoading: "正在查核近 15 年資料涵蓋狀態…",
  evidenceHistoryCoverageComplete: "15 年資料涵蓋完整",
  evidenceHistoryCoverageIncomplete: "15 年資料涵蓋不完整",
  evidenceHistoryCoverageUnavailable: "目前無法確認 15 年資料涵蓋狀態",
  evidenceHistoryAbsenceWarning: "查無紀錄不能解讀為安全",
  evidenceUrl: "來源連結",
