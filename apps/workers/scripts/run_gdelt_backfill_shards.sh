...
export SOURCE_NEWS_ENABLED="${SOURCE_NEWS_ENABLED:-true}"
export SOURCE_TERMS_REVIEW_ACK="${SOURCE_TERMS_REVIEW_ACK:-true}"
export GDELT_SOURCE_ENABLED="${GDELT_SOURCE_ENABLED:-true}"
export GDELT_BACKFILL_ENABLED="${GDELT_BACKFILL_ENABLED:-true}"
export GDELT_PRODUCTION_INGESTION_ENABLED="${GDELT_PRODUCTION_INGESTION_ENABLED:-true}"
export GDELT_REQUIRE_GEOCODER_MATCH="${GDELT_REQUIRE_GEOCODER_MATCH:-true}"
